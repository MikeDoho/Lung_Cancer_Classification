...
class BaseModel(nn.Module, ABC):
    ...
    def save_checkpoint(self,
        ...
        Returns:
            None
        """
        print("Model is saved at epoch {}".format(epoch))
    ...
    def load_checkpoint(self,
        ...
        Args:
            directory (str): Path to load checkpoint from.
            name (str): The name to load the checkpoint file as.
        ...
        name = directory
        # name = "{}_BEST.pth".format(directory)
        # name = "{}_last_epoch.pth".format(directory)
        
        self.load_state_dict(torch.load(name)['model_state_dict'])
        print("pre-trained model from {} is loaded".format(name))
