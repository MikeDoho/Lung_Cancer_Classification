...
for j, saved_model_name in enumerate(saved_end_model_120):
    ...
    if args.mc_do.lower() == 'true':
        ...
        epistemic_uncertainty_store_dir = '/home/s185479/Python/Working_Projects/Lung_Cancer_Classification/Data/Uncertainty/Epistemic/'
    ...
    if args.do_tta.lower() == 'true':
        ...
        aleatoric_uncertainty_store_dir = '/home/s185479/Python/Working_Projects/Lung_Cancer_Classification/Data/Uncertainty/Aleatoric/'
