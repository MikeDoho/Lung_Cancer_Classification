...
from lib.Loading.residual_disease_primary_data_loader import Residual_Disease_Primary
...
class Trainer:
    ...
    def training(self):
        ...
        for k, v in self.args.store_outcome_val_values.items():
            ...
            plt.plot(v)
            plt.title(k)
            plt.savefig(os.path.join(train_val_values_model_dir, f"{self.args.short_note}_{k}_val_fold_{self.args.single_fold}.jpg"))
            plt.clf()
        ...
        if self.args.clinical_model_on.lower() == 'true':
            ...
            look_at_train.to_csv(
                ...
                f"/Data/look_at_clinic/trainlook_primary_{self.args.random_value_for_fold[self.args.cv_count_csv_save]}.csv")
            ...
            # Validation results
            store_all_label_pred_dir = r'/data/maia/mdohop/Holman_Pathway/Residual_Disease/Pytorch/Data/saved_predictions/primary_predictions'
        ...
        training_dataset = Residual_Disease_Primary(self.args,
                                               mode='train',
        ...
        ### ASSESSING IMAGE MODEL (training) ###
        ...
        validation_dataset = Residual_Disease_Primary(self.args,
                                                 mode='val',
                                                 dataset_path=self.args.main_input_dir,
                                                 exclude_mrns=self.args.exclude_mrns)
        ...
        if self.args.clinical_model_on.lower() == 'true':
            ...
            # VALIDATION
            validation_dataset_eval = Residual_Disease_Primary(self.args,
                                                          mode='val',
                                                          dataset_path=self.args.main_input_dir,
                                                          exclude_mrns=self.args.exclude_mrns,
            ...
            # For TTA
            validation_dataset_eval_tta = Residual_Disease_Primary(self.args,
                                                              mode='val',
                                                              dataset_path=self.args.main_input_dir,
                                                              exclude_mrns=self.args.exclude_mrns,
            ...
            # TESTING
            if self.args.test_mrn_list:
                test_dataset_eval = Residual_Disease_Primary(self.args,
                                                        mode='test',
                                                        dataset_path=self.args.main_input_dir,
                                                        exclude_mrns=self.args.exclude_mrns,
                                                        clinic_image_eval=True)
                ...
                # For TTA
                test_dataset_eval_tta = Residual_Disease_Primary(self.args,
                                                            mode='test',
                                                            dataset_path=self.args.main_input_dir,
                                                            exclude_mrns=self.args.exclude_mrns,
                                                            clinic_image_eval=True, tta=True)
                ...
                train_dataset_eval = Residual_Disease_Primary(self.args,
                                                        mode='train',
                                                        dataset_path=self.args.main_input_dir,
                                                        exclude_mrns=self.args.exclude_mrns,
                                                        clinic_image_eval=True)
                ...
                # For TTA
                train_dataset_eval_tta = Residual_Disease_Primary(self.args,
                                                            mode='train',
                                                            dataset_path=self.args.main_input_dir,
                                                            exclude_mrns=self.args.exclude_mrns,
                                                            clinic_image_eval=True, tta=True)
