...
from lib.Models import resnet, resnet_class, resnet_fork_spatial
    ...
    if opt.model == 'resnet':
        ...
        if opt.in_modality > 1 and opt.is_classi:
            ...
            if opt.model_depth == 10:
                model = resnet_fork_spatial.resnet10(
                ...
                model = resnet_fork_spatial.resnet18(
                    sample_input_W=opt.input_W,
                    sample_input_H=opt.input_H,
                    sample_input_D=opt.input_D,
                    shortcut_type=opt.resnet_shortcut,
                ...
                model = resnet_fork_spatial.resnet34(
                    sample_input_W=opt.input_W,
                    sample_input_H=opt.input_H,
                    sample_input_D=opt.input_D,
                    shortcut_type=opt.resnet_shortcut,
                ...
                model = resnet_fork_spatial.resnet50(
                    sample_input_W=opt.input_W,
                    sample_input_H=opt.input_H,
                    sample_input_D=opt.input_D,
                    shortcut_type=opt.resnet_shortcut,
                ...
                model = resnet_fork_spatial.resnet101(
                    sample_input_W=opt.input_W,
                    sample_input_H=opt.input_H,
                    sample_input_D=opt.input_D,
                    shortcut_type=opt.resnet_shortcut,
                ...
                model = resnet_fork_spatial.resnet152(
                    sample_input_W=opt.input_W,
                    sample_input_H=opt.input_H,
                    sample_input_D=opt.input_D,
                    shortcut_type=opt.resnet_shortcut,
                ...
                model = resnet_fork_spatial.resnet200(
                    sample_input_W=opt.input_W,
                    sample_input_H=opt.input_H,
                    sample_input_D=opt.input_D,
                    shortcut_type=opt.resnet_shortcut,
            ...
            assert 1==0, 'have not adjusted model code appropriately for this selection'
