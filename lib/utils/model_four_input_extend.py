...
from lib.Models import resnet, resnet_class
from lib.Models import resnet_fork_four_input_extend as resnet_fork_four_input
    ...
    if opt.model == 'resnet':
        ...
        if opt.in_modality > 1 and opt.is_classi:
            ...
            if opt.model_depth == 10:
                model = resnet_fork_four_input.resnet10(
                ...
                model = resnet_fork_four_input.resnet18(
                    sample_input_W=opt.input_W,
                    sample_input_H=opt.input_H,
                    sample_input_D=opt.input_D,
                    shortcut_type=opt.resnet_shortcut,
                ...
                model = resnet_fork_four_input.resnet34(
                    sample_input_W=opt.input_W,
                    sample_input_H=opt.input_H,
                    sample_input_D=opt.input_D,
                    shortcut_type=opt.resnet_shortcut,
                ...
                model = resnet_fork_four_input.resnet50(
                    sample_input_W=opt.input_W,
                    sample_input_H=opt.input_H,
                    sample_input_D=opt.input_D,
                    shortcut_type=opt.resnet_shortcut,
                ...
                model = resnet_fork_four_input.resnet101(
                    sample_input_W=opt.input_W,
                    sample_input_H=opt.input_H,
                    sample_input_D=opt.input_D,
                    shortcut_type=opt.resnet_shortcut,
                ...
                model = resnet_fork_four_input.resnet152(
                    sample_input_W=opt.input_W,
                    sample_input_H=opt.input_H,
                    sample_input_D=opt.input_D,
                    shortcut_type=opt.resnet_shortcut,
                ...
                model = resnet_fork_four_input.resnet200(
                    sample_input_W=opt.input_W,
                    sample_input_H=opt.input_H,
                    sample_input_D=opt.input_D,
                    shortcut_type=opt.resnet_shortcut,
